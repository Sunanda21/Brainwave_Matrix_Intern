                ...
                <div class="bg-light p-30 mb-5">
                    <div class="row">
                        <div class="col-md-6 form-group">
                            ...
                            <input class="form-control" type="text"  name="name" value="<?= $row1->uname ?>" >
                        </div>
                        
                        <div class="col-md-6 form-group">
                            <label>E-mail</label>
                            <input class="form-control" type="text"  name="email" value="<?= $row1->uemail ?>"  >
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Mobile No</label>
                            <input class="form-control" type="text"  name="phone" value="<?= $row1->uphone ?>" >
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Address / Location</label>
                            <textarea class="form-control" type="text"  name="address" ><?= $row1->uaddress ?></textarea>
                        </div>
                        ...
                        <div class="col-md-6 form-group">
                            <label>City</label>
                            <input class="form-control" type="text" placeholder="New York" value="">
                        </div>
                         -->
                        <div class="col-md-12">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" onclick="copy()" id="shipto">
                                <label class="custom-control-label" for="shipto"  data-toggle="collapse" data-target="#shipping-address">Ship to same address</label>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="bg-light p-30">
                         <div class="form-group">
                            <div class="custom-control custom-radio">
                                <input type="radio" class="custom-control-input" name="payment" id="phonepe" value="phonepe">
