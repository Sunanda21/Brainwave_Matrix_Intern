...
<body>
  ...
  <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
    ...
    <path d="M16 0c-8.836 0-16 7.164-16 16 0 2.826 0.738 5.571 2.137 7.978l-2.137 7.65 7.822-2.112c2.309 1.261 4.922 1.939 7.687 1.939 8.836 0 16-7.164 16-16s-7.164-16-16-16zM16 28.391c-2.546 0-5.031-0.68-7.172-1.969l-0.513-0.306-4.653 1.26 1.264-4.536-0.332-0.537c-1.324-2.14-2.022-4.602-2.022-7.153 0-7.283 5.934-13.216 13.216-13.216 7.283 0 13.216 5.933 13.216 13.216s-5.933 13.216-13.216 13.216zM23.089 19.538c-0.373-0.186-2.202-1.088-2.544-1.209-0.343-0.123-0.593-0.186-0.843 0.186-0.248 0.37-0.97 1.209-1.189 1.458-0.219 0.248-0.437 0.28-0.811 0.093-0.373-0.186-1.575-0.577-3.003-1.838-1.11-0.99-1.859-2.213-2.08-2.586-0.219-0.373-0.023-0.577 0.165-0.763 0.17-0.169 0.373-0.437 0.558-0.655 0.186-0.219 0.248-0.373 0.373-0.622 0.123-0.248 0.062-0.466-0.031-0.655-0.093-0.186-0.843-2.032-1.155-2.777-0.303-0.73-0.609-0.631-0.843-0.631-0.218 0-0.466-0.031-0.717-0.031s-0.655 0.093-1.001 0.466c-0.343 0.37-1.298 1.268-1.298 3.089s1.33 3.582 1.516 3.838c0.186 0.248 2.535 3.872 6.146 5.42 0.859 0.372 1.531 0.595 2.054 0.777 0.862 0.274 1.646 0.236 2.265 0.144 0.689-0.103 2.202-0.9 2.514-1.77 0.31-0.87 0.31-1.611 0.217-1.77-0.093-0.155-0.341-0.248-0.714-0.434z" fill="#FFFFFF"/>
  </symbol>
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center">
          ...
          <div class="social">
            <ul class="info d-flex flex-wrap list-unstyled m-0">
              ...
              <li class="nav-item px-3 py-2 py-lg-0 dropdown">
                    <a class="nav-link fw-semibold p-0 dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button"
                      ...
                      <?php
                            ...
                            {
                            print' <a href="#"><button class="dropdown-item" type="button">PROFILE</button></a>
              ...
              <li class="social-icon text-black d-flex align-items-center me-2">
                Follow us:
              </li>
              <li class="social-icon text-dark d-flex align-items-center me-2">
              ...
              <li class="social-icon text-dark d-flex align-items-center me-2">
               <a class="whatsapp-icon" href="https://wa.me/918670831475?text=Hi!%20I%20am%20interested%20in%20your%20services." target="_blank">
          ...
          <div class="offcanvas-body align-items-center justify-content-end">
            <ul class="navbar-nav mb-2 mb-lg-0">
              <li class="nav-item px-3 py-2 py-lg-0">
                <a class="nav-link fw-semibold active p-0" aria-current="page" href="index.php">Home</a>
              </li>
              <li class="nav-item px-3 py-2 py-lg-0">
                <a class="nav-link fw-semibold p-0" aria-current="page" href="abouts.php">About Us</a>
              </li>
                ...
                <ul class="dropdown-menu dropdown-menu-end animate slide mt-3 border-0 shadow">
                  ...
                  <?php
                      ...
                      while($row = $res->fetch_object()){
                        ...
                        print '<li><a href="Pdetails.php?cid='.$row->cid.'" class="dropdown-item">'.$row->cname.' </a></li>';
                ...
                <ul class="dropdown-menu dropdown-menu-end animate slide mt-3 border-0 shadow">
                  ...
                  <?php
                      ...
                      while($row = $res->fetch_object()){
                        ...
                        print '<li><a href="Sdetails.php?sid='.$row->sid.'" class="dropdown-item">'.$row->sname.' </a></li>';
              ...
              <li class="nav-item px-3 py-2 py-lg-0">
                <a class="nav-link fw-semibold p-0" href="contact.php">Contact</a>
              </li>
              <li class="nav-item px-3 py-2 py-lg-0">
                <a class="nav-link fw-semibold p-0" href="add.php">Shopping Cart</a>
              </li>
